...
int main(int argc, char **argv)
{
    ...
    cout << "SlamConfig::dbowVocP() " << SlamConfig::dbowVocP() << std::endl;
    ...
    cout << "SlamConfig::dbowVocL() " << SlamConfig::dbowVocL() << std::endl;
    // read dataset root dir fron environment variable
    boost::filesystem::path dataset_path("/home/flshyi/euroc_data/V101/mav0");//string( getenv("DATASETS_DIR")));
    cout << "dataset_path " << dataset_path << std::endl;
    ...
    cout << "dataset_name " << dataset_name << std::endl;
    if (!boost::filesystem::exists(dataset_name) || !boost::filesystem::is_directory(dataset_name)) {
